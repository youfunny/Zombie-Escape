...
public class PowerUp : MonoBehaviour
{
    ...
    {
        Damage,        //+урон, рэнджа, скорость перезарядки и магазин
        Health,        //+макс хп и лечит. усиливает регенерацию хп. +invicibility time
        Speed,         //+скорость ходьбы и бега. +выносливость -экзост тайм
        Penetrating    //+армор и +армор пробитие
    }
